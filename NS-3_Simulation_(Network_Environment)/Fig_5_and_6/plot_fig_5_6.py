...
csv_path = os.path.expanduser("results_fig_5_6.csv")
...
grouped = df.groupby("nruDensity_nodes_per_m2").agg(
...
x = grouped["nruDensity_nodes_per_m2"].values
...
ax.set_title('Fig. 5 Throughput vs density of NR-U gNBs', fontsize=14)
ax.set_xlabel('Density of NR-U gNBs ($gNBs/m^2$)', fontsize=12)
...
fig.tight_layout()
fig.savefig(os.path.join(OUT_DIR, "Fig_5_Throughput_vs_Density.png"), dpi=300)
print("Saved Fig_5_Throughput_vs_Density.png")
...
ax.set_title('Fig. 6 Packet delay vs the density of NR-U gNBs', fontsize=14)
ax.set_xlabel('Density of NR-U gNBs ($gNBs/m^2$)', fontsize=12)
...
ax.ticklabel_format(style='sci', axis='x', scilimits=(0, 0))
fig.tight_layout()
fig.savefig(os.path.join(OUT_DIR, "Fig_6_Delay_vs_Density.png"), dpi=300)
print("Saved Fig_6_Delay_vs_Density.png")
